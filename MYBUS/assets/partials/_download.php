        ...
        <div class="well col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
            <div class="row">
                <div class="col-xs-6 col-sm-6 col-md-6">
                    <address>
                        <strong>SH TRAVELS</strong>
                        <br>
                        FM-SAFFAN, <BR>+94752070198
            ...
            <div class="row">
                <div class="text-center">
                    <h4><b>REFERANCE-NO:</b> <?php echo $pnr; ?></h5>
                ...
                <table class="table table-hover table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="col-md-6 text-center"><?php echo $booked_amount; ?></td>
                           
                        </tr>

                        <tr>
                           
                            <td class="col-md-6"><em><b> Date:</b></em></h4></td>
                        ...
                        <tr>
                            ...
                            <td class="col-md-6"><em><b>Time:</b></em></h4></td>
