...
<head>
    ...
    <title>SH Bus Ticket Bookings</title>
    <!-- google fonts -->
...
<body>
    ...
    <header>
        <nav>
            ...
            <div>
                ...
                <a href="#pnr-enquiry" class="pnr nav-item">REFERANCE-NO</a>
            </div>
        </nav>
    </header>
    <!-- Login Modal -->
    ...
    <section id="home">
        <div id="route-search-form">
            <h1>SH Bus Ticket Booking System</h1>

            <p class="text-center">Welcome to SH Bus Ticket Booking System. Login now to manage bus tickets and much more. OR, simply scroll down to check the Ticket status using Passenger Name Record (REFERANCE number)</p>
    ...
    <div id="block">
        ...
        <section id="pnr-enquiry">
            <div id="pnr-form">
                ...
                <form action="<?php echo $_SERVER["REQUEST_URI"]; ?>" method="POST">
                    <div>
                        <input type="text" name="pnr" id="pnr" placeholder="Enter REFERANCE">
                    </div>
        ...
        <section id="contact">
            <div class="container">
    <div class="page-header"><h1 align="center">Contact Us</h1></div>
    <div class="gap gap-small"></div>
    <div class="row">
        <div class="col-md-7">
            <h4>Reach us for any of the following matters, we reply each and every calls, messages, emails, everything</h4>
            <ul>
                <li>
                    <h3>Passengers</h3>
                ...
                <li>
                    ...
                    <p>Interested in our bus booking management software? Buy now from us with full fledged features and
                    kickstart business immediately without wasting time in developing software</p>
                </li>
            </ul>
        </div>
        <div class="col-md-4">
            <aside class="sidebar-right">
                <ul class="address-list list">
                    <li>
                        <h5>Phone Number</h5><a >(+94) 75 207 0198</a>
                    </li>
                    <li>
                        <h5>Email</h5><a href="farooksaffan777@gmail.com">farooksaffan777@gmail.com</a>
                    </li>
                    <li>
                        <h5>Facebook Messenger</h5><a href="http://m.me/farook M saffan">Chat with us</a>
                    </li>
                    <li>
                        <h5>WhatsApp</h5><a href="https://wa.me/94766764848">WhatsApp us to +94 75 207 0198</a>
                    </li>
                    <li>
                        <h5>Address</h5>
                        <address>FM-TECH PVT (LTD)<br/>562 B GAFOOR ROAD<br/>SAINTHAMARUTHU 16 32280<br/>Sri Lanka<br/>
                        </address>
                    </li>
                </ul>
            </aside>
        ...
        <footer>
        <p>
                        <i class="far fa-copyright"></i> <?php echo date('Y');?> - SH Bus Ticket Booking System | Made with &#10084;&#65039; by SAFFAN-FM
                        </p>
        </footer>
    </div>
